...
public class TestStringInValidator extends BaseValidatorTest {

    @Before
    public void init() {
        try {
            this.initChain(ServiceExampleTestAnnotation.class, ServiceExampleTestAnnotation.class.getDeclaredMethod("testStringIn", String.class));
        } catch (Exception e) {
            e.printStackTrace();
        }
