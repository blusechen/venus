...
public class TestVisitorPolicyValidator extends BaseValidatorTest {

    @Before
    public void init() {
        try {
            this.initChain(ServiceExampleTestAnnotation.class, ServiceExampleTestAnnotation.class.getDeclaredMethod("testPolicy", AccountTestAnnotation.class));
        } catch (Exception e) {
            // ignore here
        }
