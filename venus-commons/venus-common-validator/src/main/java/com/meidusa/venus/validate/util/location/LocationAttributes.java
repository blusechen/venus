 ...
 * @since 2.1.8
 * @version $Id: LocationAttributes.java 894087 2009-12-27 18:00:13Z martinc $
 */
public class LocationAttributes {
     ...
     * element, consider using {@link #getLocation(Attributes, String)} and the {@link Locatable} interface.
     * 
     * @param attrs the element's attributes that hold the location information
    ...
    public static Location getLocation(Element elem, String description) {
        ...
        return new LocationImpl(description == null ? elem.getNodeName() : description, srcAttr.getValue(), getLine(elem), getColumn(elem));
    }
     ...
     * kept into an object built from this element, consider using {@link #getLocation(Element)} and the
