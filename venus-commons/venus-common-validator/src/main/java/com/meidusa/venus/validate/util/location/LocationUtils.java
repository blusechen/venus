...
public class LocationUtils {
     ...
     * <code>foo - file://path/to/file.xml:3:40</code>"). For {@link Location#UNKNOWN an unknown location}, returns
     * {@link #UNKNOWN_STRING}.
     * 
    ...
    /**
     * Add a {@link LocationFinder} to the list of finders that will be queried for an object's location by
