...
/**
 * <!-- START SNIPPET: javadoc --> Field Validator that checks if the double specified is within a certain range. <!--
 * END SNIPPET: javadoc -->
 * 
 * 
 ...
 * required</li>
 * <li>minInclusive - the minimum inclusive value in FloatValue format specified by Java language (if none is specified,
 * it will not be checked)</li>
 * <li>maxInclusive - the maximum inclusive value in FloatValue format specified by Java language (if none is specified,
 * it will not be checked)</li>
 * <li>minExclusive - the minimum exclusive value in FloatValue format specified by Java language (if none is specified,
 * it will not be checked)</li>
 * <li>maxExclusive - the maximum exclusive value in FloatValue format specified by Java language (if none is specified,
 * it will not be checked)</li>
 * </ul>
 ...
 * @author Rene Gielen
 * 
 * @version $Id: DoubleRangeFieldValidator.java 894090 2009-12-27 18:18:29Z martinc $
 */
...
public class DoubleRangeFieldValidator extends FieldValidatorSupport {
    ...
    public void validate(Object object) throws ValidationException {
        ...
        if ((maxInclusiveValue != null && value.compareTo(maxInclusiveValue) > 0) || (minInclusiveValue != null && value.compareTo(minInclusiveValue) < 0)
        ...
        if (value != null) {
            try {
                ...
                if (logger.isWarnEnabled()) {
                    logger.warn("DoubleRangeFieldValidator - [parseDouble]: Unable to parse given double parameter " + value);
                }
            }
        }
        return null;
