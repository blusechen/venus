...
/**
 * A location in a resource. The location is composed of the URI of the resource, and the line and column numbers within
 * that resource (when available), along with a description.
 * <p>
