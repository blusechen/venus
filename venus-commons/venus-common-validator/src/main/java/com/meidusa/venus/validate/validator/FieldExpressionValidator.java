...
/**
 * <!-- START SNIPPET: javadoc --> Validates a field using an OGNL expression. <!-- END SNIPPET: javadoc -->
 * <p/>
 * 
...
public class FieldExpressionValidator extends FieldValidatorSupport {
    ...
    public void validate(Object object) throws ValidationException {
        ...
        try {
            OgnlBasicValueHolder valueHolder = new OgnlBasicValueHolder();
            valueHolder.setRoot(object);
            obj = valueHolder.findValue(expression);
        } catch (Exception e) {
