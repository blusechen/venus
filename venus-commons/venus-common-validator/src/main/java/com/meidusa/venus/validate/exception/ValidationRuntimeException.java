 ...
 */
public class ValidationRuntimeException extends RuntimeException implements Locatable {
    ...
    /**
     * Constructs a <code>XWorkException</code> with the specified detail message.
     * 
    ...
    /**
     * Constructs a <code>XWorkException</code> with the specified detail message and target.
     * 
     * @param s the detail message.
     * @param target the target of the exception.
     */
    public ValidationRuntimeException(String s, Object target) {
     ...
     * @param target The target of the exception
     */
    public ValidationRuntimeException(Throwable cause, Object target) {
        this(null, cause, target);
    }

    /**
     * Constructs a <code>XWorkException</code> with the specified detail message and exception cause.
     * 
     * @param s the detail message.
     * @param cause the wrapped exception
     */
    public ValidationRuntimeException(String s, Throwable cause) {
        this(s, cause, null);
    }

    /**
     * Constructs a <code>XWorkException</code> with the specified detail message, cause, and target
     * 
     * @param s the detail message.
     * @param cause The wrapped exception
     * @param target The target of the exception
     */
    public ValidationRuntimeException(String s, Throwable cause, Object target) {
        super(s, cause);
    ...
    /**
     * Returns a short description of this throwable object, including the location. If no detailed message is
     * available, it will use the message of the underlying exception if available.
     * 
