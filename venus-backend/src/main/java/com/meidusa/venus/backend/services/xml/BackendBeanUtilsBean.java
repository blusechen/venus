...
/**
 * Created by godzillahua on 6/16/16.
 */
public class BackendBeanUtilsBean extends BeanUtilsBean {
    ...
    public BackendBeanUtilsBean(BeanContext beanContext, ConvertUtilsBean convertUtilsBean, PropertyUtilsBean propertyUtilsBean){
