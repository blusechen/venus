...
class ServiceRunnable extends MultiQueueRunnable {
    ...
    public void doRun() {
        ...
        try {
            ...
            RequestInfo info = handler.getRequestInfo(packetSerializeType, conn, finalRouterPacket, requestFinal);
            RequestContext context = handler.createContext(info, conn,endpoint, paramters);
